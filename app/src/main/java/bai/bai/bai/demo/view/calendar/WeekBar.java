...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("bai.bai.bai.demo.view.calendar.WeekBar".equals(getClass().getName())) {
            LayoutInflater.from(context).inflate(R.layout.view_calendar_week_bar_def, this, true);
        }
    }
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("bai.bai.bai.demo.view.calendar.WeekBar".equalsIgnoreCase(getClass().getName())) {

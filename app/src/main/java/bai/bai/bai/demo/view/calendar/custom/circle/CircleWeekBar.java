package bai.bai.bai.demo.view.calendar.custom.circle;
...
import bai.bai.bai.demo.view.calendar.WeekBar;
...
public class CircleWeekBar extends WeekBar {
    ...
    public CircleWeekBar(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.view_calendar_week_bar_circle, this, true);

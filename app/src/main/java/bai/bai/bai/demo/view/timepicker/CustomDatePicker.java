...
public class CustomDatePicker {
    ...
    private void initView() {
        ...
        TextView tv_title = datePickerDialog.findViewById(R.id.tv_title);
        TextView tv_cancle = datePickerDialog.findViewById(R.id.tv_cancle);
        TextView tv_select = datePickerDialog.findViewById(R.id.tv_select);

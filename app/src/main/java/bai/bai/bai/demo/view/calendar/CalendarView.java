 ...
 */
package bai.bai.bai.demo.view.calendar;
...
public class CalendarView extends FrameLayout {
    ...
    private void init(Context context) {
        View contentView = LayoutInflater.from(context).inflate(R.layout.view_calendar_layout_calendar_view, this, true);
        FrameLayout frameContent = contentView.findViewById(R.id.frameContent);
        this.mWeekPager = contentView.findViewById(R.id.vp_week);
        ...
        this.mMonthPager = contentView.findViewById(R.id.vp_month);
        ...
        mYearViewPager = contentView.findViewById(R.id.selectLayout);
    ...
    /**
     * 设置月视图(即备注和选中背景的样式，可直接继承MonthView.class进行自己的自定义)
     *
    ...
    /**
     * 设置周栏视图(即星期栏样式，可直接继承WeekBar.class进行自己的自定义)
     */
